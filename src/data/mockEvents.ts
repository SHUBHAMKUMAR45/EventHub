...
export const eventTypes = ["Workshop", "Music", "Sports", "Meetup", "Entertainment", "Fitness", "Social"];

export const locations = [...new Set(mockEvents.map(event => event.location))].sort();